...
@section('page_subtitle', 'Masukkan profil siswa baru ke dalam sistem.')
    ...
    <div style="max-width: 600px; margin: 0 auto;">
        <div class="section-card">
            <div class="section-header">
                ...
                <a href="{{ route('students.index') }}" class="btn btn-secondary btn-sm">Batal</a>
            </div>
            ...
            <form action="{{ route('students.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nisn" name="nisn" value="{{ old('nisn') }}" placeholder="Contoh: 0081234567" class="form-control" maxlength="10" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: Aditya Pratama" class="form-control" required>
                </div>

                <div class="form-group">
                    <label for="class" class="form-label">Kelas</label>
                    <input type="text" id="class" name="class" value="{{ old('class') }}" placeholder="Contoh: XI IPA 1, X IPS 2" class="form-control" required>
                </div>
